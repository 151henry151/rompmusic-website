...
- Document nginx reverse-proxy client-route redirects in install guide (/playlists, /album/*, /track/*, etc. → /app/...).
...
- Synchronize website version metadata with umbrella/client `0.1.10` release references.
- Set `package.json` and `package-lock.json` version to `0.1.10`.

## [0.1.9] - 2026-03-06

### Changed

- Synchronize website version metadata with umbrella/client `0.1.9` release references.
- Set `package.json` and `package-lock.json` version to `0.1.9`.

## [0.1.8] - 2026-03-06

### Changed

- Synchronize website version metadata with umbrella/client `0.1.8` release references.
- Set `package.json` and `package-lock.json` version to `0.1.8`.
...
- Synchronize website version metadata with umbrella/client `0.1.6` release references.
- Set `package.json` and `package-lock.json` version to `0.1.6`.

## [0.1.5] - 2026-03-05

### Changed

- Synchronize website version metadata with umbrella/client `0.1.5` release references.
...
[Unreleased]: https://github.com/151henry151/rompmusic-website/compare/v0.1.10...HEAD
[0.1.10]: https://github.com/151henry151/rompmusic-website/releases/tag/v0.1.10
[0.1.9]: https://github.com/151henry151/rompmusic-website/releases/tag/v0.1.9
[0.1.8]: https://github.com/151henry151/rompmusic-website/releases/tag/v0.1.8
...
[0.1.3]: https://github.com/151henry151/rompmusic-website/releases/tag/v0.1.3
[0.1.1]: https://github.com/151henry151/rompmusic-website/releases/tag/v0.1.1
[0.1.0]: https://github.com/151henry151/rompmusic-website/releases/tag/v0.1.0
[0.1.0-beta.17]: https://github.com/151henry151/rompmusic-website/releases/tag/v0.1.0-beta.17
[0.1.0-beta.16]: https://github.com/151henry151/rompmusic-website/releases/tag/v0.1.0-beta.16
